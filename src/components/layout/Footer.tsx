...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-foreground to-primary text-white">
            ...
            <ul className="space-y-3">
              {footerLinks.company.map((link) => (
                <li key={link.name}>
                  <Link
                    to={link.href}
                    className="text-white/80 hover:text-secondary-brand transition-colors duration-200"
                  >
                    {link.name}
                  </Link>
                </li>
                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <a
                      key={social.name}
                      href={social.href}
                      className="w-10 h-10 bg-white/10 rounded-lg flex items-center justify-center hover:bg-secondary-brand transition-all duration-200 group"
                      target="_blank"
